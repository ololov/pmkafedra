			...
			<table id = "about">
				...
				<tr>	<td class = "t_photo"><img  src="photo/3.png" class = "worker_photo"></td>
					<td><p class = "subtit">Куликова Юлия</p>
						Mенеджером проекта. Все возникающие споры разрешает демократично - при помощи голосования.
						Единственный человек в нашей команде занимающиеся дизайном сайта.
						99% CSS кода принадлежит ей. Однако её работа этим не ограничивается.
						Её труд "простирается" от пополнения базы данных до разделов "Новости", "Студенту",
						"Дисциплины" и "О сайте".
					</td>
				</tr>
