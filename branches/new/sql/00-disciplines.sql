...
--SELECT ADDDISC('Алгебра и аналитическая геометрия', ARRAY[1,2], 64, 35, 0, 'нет', 'экзамен');
--SELECT ADDDISC('Математический анализ', ARRAY[1,2], 88, 64, 0, '"Поверхности"', 'экзамен');
---SELECT ADDDISC('Программные и аппаратные средства информатики', ARRAY[1], 10, 3, 6, 'нет', 'экзамен');
--SELECT ADDDISC('Физика', ARRAY[1,2], 54, 32, 12, 'нет', 'экзамен');
