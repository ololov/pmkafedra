...
//		$group = "1-1";
		...
		*/
		...
		if(!empty($data)){
			...
			echo "</table>";
			echo "<a href=\"#\" onclick=\"dynPageObj.setUrl('students/schedule/getschedule.php?week=".($week+1)."&group=".$group."');dynPageObj.loadPage();this.style.display='none';return false\">Next week</a> ";
